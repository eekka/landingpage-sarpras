                ...
                <div class="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-scroll overflow-x-hidden shadow-2xl modal-panel">
                    ...
                    <div>
                        ...
                        <div class="p-6 modal-info-utama modal-info-block" data-slide="1">
                            ...
                            <div class="mt-3.5">
                                <p class="text-gray-600 text-lg mb-3 modal-info-desc">Mencari tempat pertemuan berukuran menengah tidak akan sulit karena Aula Anggrek telah mempresentasikannya kepada Anda. Sempurna untuk acara formal maupun gathering dan reuni.</p>
                                <p class="text-gray-600 text-lg mb-3">Fasilitas dan keuntungan yang disediakan:</p>
                                <ul class="modal-info-list list-disc">
                ...
                <div class="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-scroll overflow-x-hidden shadow-2xl modal-panel">
                    ...
                    <div class="relative">
                        <div class="swiper modal-img-swiper py-4 overflow-x-hidden" id="swiperRuang" style="height: 360px;">
                            <div class="swiper-wrapper ">
                                ...
                                <div class="swiper-slide group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('images/ruang/mawar/m6.jpeg') ?>" data-alt="Ruang Kelas - Gambar 1">
                    ...
                    <div>
                        ...
                        <div class="p-6 modal-info-pendukung modal-info-block" data-slide="0">
                            ...
                            <div class="mt-3.5">
                                ...
                                <ul class="modal-info-list list-disc">
                                    ...
                                    <li>Kapasitas ruangan dapat menampung ±70 orang</li>
                        ...
                        <div class="p-6 modal-info-pendukung modal-info-block hidden" data-slide="1">
                            ...
                            <div class="swiperimg mySwiperimg">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('images/ruang/bougenville/b1.jpeg') ?>" data-alt="Ruang Bougenville - Gambar 1">
                                        <img src="<?= base_url('images/ruang/bougenville/b1.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                            <span class="text-white font-bold opacity-0 group-hover:opacity-100 transition-opacity">Ruang Bougenville - Gambar 1</span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('images/ruang/bougenville/b2.jpeg') ?>" data-alt="Ruang Bougenville - Gambar 2">
                                        <img src="<?= base_url('images/ruang/bougenville/b2.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                            <span class="text-white font-bold opacity-0 group-hover:opacity-100 transition-opacity">Ruang Bougenville - Gambar 2</span>
                                        </div>
                                    </div>                            
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('images/ruang/bougenville/b3.jpeg') ?>" data-alt="Ruang Bougenville - Gambar 3">
                                        <img src="<?= base_url('images/ruang/bougenville/b3.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                            <span class="text-white font-bold opacity-0 group-hover:opacity-100 transition-opacity">Ruang Bougenville - Gambar 3</span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('images/ruang/bougenville/b4.jpeg') ?>" data-alt="Ruang Bougenville - Gambar 4">
                                        <img src="<?= base_url('images/ruang/bougenville/b4.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                            <span class="text-white font-bold opacity-0 group-hover:opacity-100 transition-opacity">Ruang Bougenville - Gambar 4</span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('images/ruang/bougenville/b5.jpeg') ?>" data-alt="Ruang Bougenville - Gambar 5">
                                        <img src="<?= base_url('images/ruang/bougenville/b5.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                            <span class="text-white font-bold opacity-0 group-hover:opacity-100 transition-opacity">Ruang Bougenville - Gambar 5</span>
                                        </div>
                                    </div>                                                                                                                                                                                                                    
                                </div>
                                <div class="swiper-pagination"></div>
                ...
                <div class="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-scroll overflow-x-hidden shadow-2xl modal-panel">
                    ...
                    <div>
                        ...
                        <div class="p-6 modal-info-publik modal-info-block" data-slide="0">
                            <div class="flex flex-col">
                                ...
                                <div class="flex flex-col md:flex-row md:items-center gap-4 mb-3 justify-between">
                                    <div class="inline-block bg-blue-100 border border-blue-300 px-3 py-2 rounded-lg mb-3">
                                        ...
                                        <p class="text-gray-700 text-sm">
                                            <span class="font-bold">Kapasitas :</span> 3-4 orang
                                        </p>
                                    </div>
                                    <div class="w-full md:w-auto">
                            ...
                            <div class="mt-3.5">
                                <p class="text-gray-600 text-lg mb-3 modal-info-desc">Mencari akomodasi rombongan yang tetap mengutamakan privasi dan fasilitas lengkap? Asrama Matahari adalah jawaban bagi instansi, komunitas, atau keluarga besar yang memerlukan hunian kolektif dengan standar kenyamanan hotel. Dengan total 46 kamar yang didesain modern, kami siap menyambut rombongan Anda dalam suasana yang hangat dan tertata rapi.</p>
                                <p class="text-gray-600 text-lg mb-3">Fasilitas dan keuntungan yang disediakan:</p>
                                <ul class="modal-info-list list-disc">
                        ...
                        <div class="p-6 modal-info-publik modal-info-block hidden" data-slide="1">
                            ...
                            <div class="mt-3.5">
                                <p class="text-gray-600 text-lg mb-3 modal-info-desc">Ruangan sementara yang bisa ditempati oleh tamu Balatkop UKM Jateng, ketika hendak menginap di Asrama Matahari.</p>
                                <p class="text-gray-600 text-lg mb-3">Fasilitas dan keuntungan yang disediakan:</p>
                                <ul class="modal-info-list list-di">
                        ...
                        <div class="p-6 modal-info-publik modal-info-block hidden" data-slide="2">
                            ...
                            <div class="mt-3.5">
                                <p class="text-gray-600 text-lg mb-3 modal-info-desc">Ruangan luas yang ada di Asrama Matahari. Tempat tamu Asrama Matahari yang mengikuti pelatihan dapat menyantap makanan yang telah disediakan.</p>
                                <p class="text-gray-600 text-lg mb-3">Fasilitas dan keuntungan yang disediakan:</p>
                                <ul class="modal-info-list list-disc">
                                    <li>Terletak di lantai 1. Ruangan berada di dekat resepsionis </li>
                ...
                <div class="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-scroll overflow-x-hidden shadow-2xl modal-panel">
                    <div class="relative">
                        <div class="swiper modal-img-swiper py-4" id="swiperLaboratorium" style="height: 360px;">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('/images/lab/batik/lab-batik.jpeg') ?>" data-alt="Laboratorium Batik">
                                    <img src="<?= base_url('/images/lab/batik/lab-batik.jpeg') ?>" class="w-full h-full object-cover">
                                    <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);"> 
                                ...
                                <div class="swiper-slide group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('/images/lab/lab-boga.jpeg') ?>" data-alt="Laboratorium Tata Boga">
                                    <img src="<?= base_url('/images/lab/boga/lab-boga.jpeg') ?>" class="w-full h-full object-cover">
                                    <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                ...
                                <div class="swiper-slide group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('/images/lab/lab komputer.jpeg') ?>" data-alt="Laboratorium Komputer">
                                    <img src="<?= base_url('/images/lab/komputer/lab komputer.jpeg') ?>" class="w-full h-full object-cover">
                                    <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                    ...
                    <div>
                        ...
                        <div class="p-6 modal-info-laboratorium modal-info-block" data-slide="0">
                            ...
                            <div class="swiperimg mySwiperimg">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('/images/lab/batik/lab-batik.jpeg') ?>" data-alt="Laboratorium Batik - Gambar 1">
                                        <img src="<?= base_url('/images/lab/batik/lab-batik.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                            <span class="text-white font-bold opacity-0 group-hover:opacity-100 transition-opacity">Laboratorium Batik - Gambar 1</span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('/images/lab/batik/batik1.jpeg') ?>" data-alt="Laboratorium Batik - Gambar 2">
                                        <img src="<?= base_url('/images/lab/batik/batik1.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                            <span class="text-white font-bold opacity-0 group-hover:opacity-100 transition-opacity">Laboratorium Batik - Gambar 2</span>
                                        </div>
                                    </div>                            
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" data-img="<?= base_url('/images/lab/batik/batik2.jpeg') ?>" data-alt="Laboratorium Batik - Gambar 3">
                                        <img src="<?= base_url('/images/lab/batik/batik2.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                            ...
                            <div class="mt-3.5">
                                <p class="text-gray-600 text-lg mb-3 modal-info-desc">Ruangan khusus yang didesain untuk pelestarian budaya membatik. Memberikan pengalaman otentik dalam proses pembuatan kain batik dari awal hingga akhir.</p>
                                <p class="text-gray-600 text-lg mb-3">Fasilitas dan keuntungan yang disediakan:</p>
                                <ul class="modal-info-list list-disc">
                                    ...
                                    <li>Canting</li>
                                    <li>Gawangan</li>
                                    <li>Serta alat pendukung lainnya.</li>
                                </ul>
                            </div>
                        </div>
                        <!-- tata boga -->
                        <div class="p-6 modal-info-laboratorium modal-info-block hidden" data-slide="1">
                            ...
                            <div class="swiperimg mySwiperimg">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" style="aspect-ratio: 16/9;" data-img="<?= base_url('images/lab/boga/boga1.jpeg') ?>" data-alt="Laboratorium Tata Boga - Gambar 1">
                                        <img src="<?= base_url('images/lab/boga/boga1.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                    ...
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" style="aspect-ratio: 16/9;" data-img="<?= base_url('images/lab/boga/boga2.jpeg') ?>" data-alt="Laboratorium Tata Boga - Gambar 2">
                                        <img src="<?= base_url('images/lab/boga/boga2.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                    ...
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" style="aspect-ratio: 16/9;" data-img="<?= base_url('images/lab/boga/boga4.jpeg') ?>" data-alt="Laboratorium Tata Boga - Gambar 4">
                                        <img src="<?= base_url('images/lab/boga/boga4.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                            ...
                            <div class="mt-3.5">
                                <p class="text-gray-600 text-lg mb-3 modal-info-desc">Dapur komersial yang bersih dan terorganisir. Format set class memasak yang lengkap memungkinkan peserta dibagi ke dalam tim kecil untuk kolaborasi memasak.</p>
                                <p class="text-gray-600 text-lg mb-3">Fasilitas dan keuntungan yang disediakan:</p>
                                <ul class="modal-info-list list-disc">
                        ...
                        <div class="p-6 modal-info-laboratorium modal-info-block hidden" data-slide="2">
                            ...
                            <div class="swiperimg mySwiperimg">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" style="aspect-ratio: 16/9;" data-img="<?= base_url('images/lab/komputer/lab komputer.jpeg') ?>" data-alt="Laboratorium Komputer - Gambar 1">
                                        <img src="<?= base_url('images/lab/komputer/lab komputer.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                            <span class="text-white font-bold opacity-0 group-hover:opacity-100 transition-opacity">Laboratorium Komputer - Gambar 1</span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" style="aspect-ratio: 16/9;" data-img="<?= base_url('images/lab/komputer/komputer1.jpeg') ?>" data-alt="Laboratorium Komputer - Gambar 2">
                                        <img src="<?= base_url('images/lab/komputer/komputer1.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                                    ...
                                    <div class="swiper-slide aspect-video w-94 h-auto group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-transform duration-300 hover:shadow-2xl gallery-item" style="aspect-ratio: 16/9;" data-img="<?= base_url('images/lab/komputer/komputer3.jpeg') ?>" data-alt="Laboratorium Komputer - Gambar 4">
                                        <img src="<?= base_url('images/lab/komputer/komputer3.jpeg') ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4" style="background-color: rgba(0, 0, 0, 0.14);">
                            ...
                            <div class="mt-3.5">
                                <p class="text-gray-600 text-lg mb-3 modal-info-desc">Ruang komputer yang siap pakai dengan konfigurasi yang rapi. Sangat mendukung untuk kegiatan yang memerlukan konsentrasi tinggi dan konektivitas.</p>
                                <p class="text-gray-600 text-lg mb-3">Fasilitas dan keuntungan yang disediakan:</p>
                                <ul class="modal-info-list list-disc">
        ...
        // Swiper
            ...
            (function () {
                ...
                document.addEventListener('click', (e) => {
                    ...
                    if (!item) return;
                    if (item.closest('.modal-img-swiper')) return;
